        ...
        <form className={style.form} onSubmit={formik.handleSubmit}>
          ...
          <div className={style.inputForm}>
            ...
            <div className={style.wrapperBtn}>
              <input type={togglePassword ? "text" : "password"} {...formik.getFieldProps("password")} />
          ...
          <div className={style.inputForm}>
            ...
            <div className={style.wrapperBtn}>
              <input type={togglePassword ? "text" : "password"} {...formik.getFieldProps("confirmedPassword")} />
              <button type={"button"} className={classNameBtn} onClick={onClickShowPassword}></button>
            </div>
            {formik.touched.confirmedPassword && formik.errors.confirmedPassword && <div style={{ color: "red" }}>{formik.errors.confirmedPassword}</div>}
          </div>
          <SuperButton type={"submit"}>Sign Up</SuperButton>
          <label className={style.descriptionInfo}>Already have an account?</label>
          <NavLink to={PATH.LOGIN} className={style.signUpLink}>
            Sign in
          </NavLink>
